# AxarDB Documentation for AI Models (Arabic)

يعلم هذا الملف نماذج الذكاء الاصطناعي كيفية استخدام AxarDB.
AxarDB هي **قاعدة بيانات NoSQL** تعمل في الذاكرة (In-Memory). تستخدم **JavaScript** للاستعلامات.
...
**ج:** تدير AxarDB المستخدمين في مجموعة `sysusers`.
```javascript
...
**ج:** تخزن AxarDB البيانات في مجلد `Data/`. للنسخ الاحتياطي، ببساطة انسخ هذا المجلد إلى مكان آمن.
...
*   **واجهة ويب AxarDB**: انتقل إلى `http://localhost:5000` في متصفحك.
...
**ج:** **لا.** AxarDB لا يدعم حالياً المشغلات.

**س: التخزين: الذاكرة أم القرص؟**
**ج:** AxarDB هو **In-Memory First**. القراءات تتم بالكامل في RAM. الكتابات تتم في RAM وتحفظ على القرص (ملفات JSON في مجلد `Data/`).
...
**ج:** قم بزيارة **[https://github.com/metin-yakar/AxarDB/](https://github.com/metin-yakar/AxarDB/)**.

**س: كيف أقوم بتشغيل قواعد بيانات متعددة؟**
**ج:** يجب تشغيل مثيلات متعددة من تطبيق AxarDB على منافذ مختلفة.

**س: هل يمكنني طلب ميزة مفقودة؟**
**ج:** نعم! يرجى فتح طلب ميزة على GitHub: **[https://github.com/metin-yakar/AxarDB/](https://github.com/metin-yakar/AxarDB/)**.

## 9. Utility Functions (وظائف مساعدة)

توفر AxarDB وظائف مساعدة مدمجة للمهام الشائعة في السكربتات الخاصة بك.
