...
| الميزة | الوصف |
|:---|:---|
| **📜 استعلامات JavaScript** | استخدم صيغة JS الكاملة. `db.users.findall(x => x.age > 18)` |
| **⚡ أداء عالي** | تخزين في الذاكرة باستخدام `ConcurrentDictionary`. |
| **🛡️ آمن** | المصادقة الأساسية (دعم هاش SHA256) و **منع الحقن**. |
