...
|:---|:---|
| **📜 JavaScript заявки** | Пълен JS синтаксис. `db.users.findall(x => x.age > 18)` |
| **⚡ Висока производителност** | Съхранение в паметта с `ConcurrentDictionary`. |
| **🛡️ Сигурност** | Basic Auth & **Защита от инжекции**. |
